...
describe('spotify api', () => {
    describe('search artists', () => {
        ...
        it('should fail on empty query', () => {
            ...
            expect(() => spotifyApi.searchArtists(query)).to.throw('query is empty')
        })
    })
    ...
    describe('retrieve artist', () => {
        ...
        it('should fail on empty artistId', function () {
            ...
            expect(() => spotifyApi.retrieveArtist(artistId)).to.throw('artistId is empty')
        })
    })
    ...
    describe('retrieve albums', () => {
        ...
        it('should fail on empty artistId', function () {
            ...
            expect(() => spotifyApi.retrieveAlbums(artistId)).to.throw('artistId is empty')
        })
    })
    ...
    describe('retrieve album', () => {
        ...
        it('should fail on empty albumId', function () {
            ...
            expect(() => spotifyApi.retrieveAlbum(albumId)).to.throw('albumId is empty')
        })
    })
    ...
    describe('retrieve tracks', () => {
        ...
        it('should fail on empty albumId', function () {
            ...
            expect(() => spotifyApi.retrieveTracks(albumId)).to.throw('albumId is empty')
        })
    })
    ...
    describe('retrieve track', () => {
        ...
        it('should fail on empty trackId', function () {
            ...
            expect(() => spotifyApi.retrieveTrack(trackId)).to.throw('trackId is empty')
        })
    })
})